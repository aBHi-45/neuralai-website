...
const Footer = () => {
  ...
  return (
    <motion.div variants={introVariants} initial="initial" whileInView="inView">
        ...
        >
          ...
          <Grid container style={{ marginTop: "2.2rem" }}>
            ...
            >
              ...
              <br />
              <Link
                href="mailto:neural.ai.dtu@gmail.com"
                style={{ textDecoration: "none" }}
              >
                <Typography variant="body1" color="secondary" className="mail">
                  neural.ai.dtu@gmail.com
                </Typography>
              </Link>
              <Typography variant="body1" color="primary" className="mail">
